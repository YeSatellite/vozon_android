...
class YSignUpActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        user.type = kz.vozon.vozon.models.User.COURIER

        v_city.setOnClickListener {
            val i = Intent(this@YSignUpActivity, kz.vozon.vozon.ui.info.LocationActivity::class.java)
    ...
    private fun next(){
        try{
            ...
            val i = Intent(this, kz.vozon.vozon.ui.auth.YSignUpNextActivity::class.java)
            i.put(user)
            i.put(image!!)
            startActivity(i)
