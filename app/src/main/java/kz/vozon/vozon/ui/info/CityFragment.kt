...
class CityFragment(val call: Call<List<kz.vozon.vozon.models.Location>>) : kz.vozon.vozon.ui.ListFragment<kz.vozon.vozon.models.Location, CityFragment.ViewHolder>() {
    var adapter: kz.vozon.vozon.ui.ListFragment<kz.vozon.vozon.models.Location, CityFragment.ViewHolder>.ListAdapter? = null
    var list: List<kz.vozon.vozon.models.Location> = ArrayList()
    ...
    override fun onItemClick(item: kz.vozon.vozon.models.Location){
        (activity as kz.vozon.vozon.ui.info.LocationActivity).supportActionBar!!.title = item.name
        (activity as kz.vozon.vozon.ui.info.LocationActivity).i.put(item)
