...
class YOrderWListFragment : kz.vozon.vozon.ui.ListFragment<kz.vozon.vozon.models.Order, YOrderWListFragment.ViewHolder>() {
    ...
    override fun onItemClick(item: kz.vozon.vozon.models.Order) {
        val i = Intent(activity, kz.vozon.vozon.ui.courier.order.YOrderWDetailActivity::class.java)
        i.put(item)
        startActivity(i)
    }
}
